...
use App\Http\Requests\Step1CCRequest;
...
class  CampingController extends Controller
{
    ...
    {
        $autos = Camping::where('validation', 1)->where('enpublic',1)
            ->orderBy('created_at', 'desc')
            ->paginate(3);
        $new = Camping::take('2')->where('validation',1)->orderBy('created_at' , 'desc')
        ...
        return view('front.autos.camping-car.index', compact('autos','new','newcamping' ,'Img','timezone'));
    }
    ...
    // public function getinfo1(Step1CCRequest $r)
    public function getinfo1(Request $r)
    {
        $r->session()->put('step1', $r->except('_token'));
        return \redirect('/campingstep2');
//
    }
...
// public function getinfo3(Step3Request $r)
    ...
    public function storeAuto(Request $autoRequest,Camping $auto)
    {
    ...
    public function detaillecamping($id , Camping $auto , CampingImages $images)
    {
    ...
    public function searche(Request $request, Camping $auto,AutoMarque $marque ,AutoModele $modele,PubH $pubh,PubV $pubv)
    {
        ...
        $selection = Camping::where('validation', 1)->where('enpublic',1)
            ->orderBy('created_at', 'desc')
            ->paginate(3);
        ...
        return view('front.autos.camping-car.liste-annonces', compact('autos', 'array','selection','pubh','pubv'));
    ...
    public function advencedsearchliste()
    {
        ...
        $autos = Camping::where('validation', 1)
            ->orderBy('id', 'desc')
            ->paginate(3);
