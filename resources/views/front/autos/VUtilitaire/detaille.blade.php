                                ...
                                <div class="section-heading">
                                    <div class="media">
                                        ...
                                        <div class="media-body hidden-xs">
                                            ...
                                            @if($autoInfo->vehicule_marque!=0)
                                                {{$autoInfo->vehiculemarque->vehicule_marque}}
                                            @else
                                                {{$autoInfo->new_marque}}
                                         @endif
                                ...
                                <div class="carousel-outer">
                                    ...
                                    @if( count($autoInfo->images) == 0)
                                        ...
                                        <img src={{checkIfImageIsexist($autoInfo->image)}}  height="450px" style="margin: 0 auto">
                                            ...
                                            <img src= {{  Request::root().'/public/'.getSetting('no_image')}}  height="450px" style="margin: 0 auto"  >
                                          @endif
                    ...
                    <div class="details-sidebar pad-div">
                        ...
                        <div class="sidebar-widget car-details-sidebar">
                            @if (Auth::guest())
                                ...
                                <a href="{{url('/VUpdate/'.$autoInfo->id)}}">
