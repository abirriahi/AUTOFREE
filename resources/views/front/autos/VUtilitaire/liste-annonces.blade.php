                    ...
                    @if(count($autos)  )
                        ...
                        <div class="car-list-box clearfix wow fadeInUp delay-03s">
                         <div class=" row-table row-flush">
                                ...
                                @if( $autos->image !='' )
                                    <a href="{{ url('/detailleVU/'.$autos->id) }}">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail">
                                ...
                                <header>
                                    <div class="pull-left">
                                        ...
                                        <h3 class="title">
                                            <a href="{{ url('/detailleVU/'.$autos->id) }}">
                                                {{$autos->new_marque}} {{$autos->new_modele}}</a>
                                        </h3>
                                        <!-- Custom List -->
                                        <ul class="custom-list">
                                            <li>
                                                <a href="#">@if($autos->auto_categorie!='')
                                ...
                                <!-- Btn Div -->
                                <a href="{{ url('/detailleVU/'.$autos->id) }}" class="btn btn-details">Details</a>
                            </div>
