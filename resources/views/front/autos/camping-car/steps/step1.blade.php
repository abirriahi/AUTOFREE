    <div class="b-submit__main">
        ...
        {!! Form::open( ['url' => '/campingstep1' , 'method' => 'post','enctype'=>'multipart/form-data','class'=>'s-submit clearfix', 'files'=>true]) !!}
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    <label>Couleur intérieure <span>*</span></label>
                    <div class='s-relative'>
               ...
               <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    ...
                    <div class='s-relative'>
                        {!! Form::select("autos_carrosserie" ,Camping_carrosserie() , null ,array('class' => 'm-selecttt', 'placeholder' => 'carrosserie' )) !!}
                ...
                <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    ...
                    <div class='s-relative'>
                        ...
                        'placeholder' => 'prix', 'style'=>'display: block;
width: 100%;
 padding: 15px 20px;
