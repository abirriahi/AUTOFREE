                                ...
                                <div class="carousel-outer">
                                    ...
                                    @if( count($autoInfo->images) == 0)
                                        ...
                                        <img src={{checkIfImageIsexist($autoInfo->image)}}  height="450px" style="margin: 0 auto">
                                            ...
                                            <img src= {{  Request::root().'/slider/'.getSetting('no_image')}}  height="450px" style="margin: 0 auto"  >
                                          @endif
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                @foreach($autoInfo->images as $key => $image)
                                                    <div class="item {{ $key == 0 ? 'active' : '' }} ">
                                                        <img src="{{  Request::root().'/front/images/'.$image->path}}"style="margin: 0 auto; height:450px">
                                                    </div>
                                                @endforeach
                                            </div>
                    ...
                    <div class="details-sidebar pad-div">
                        ...
                        <div class="sidebar-widget car-details-sidebar">
                            ...
                            @else
                                ...
                                <a href="{{url('/remorque/update/'.$autoInfo->id)}}">
