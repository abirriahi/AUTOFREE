                    ...
                    @if(count($autos)  )
                        ...
                        <div class="car-list-box clearfix wow fadeInUp delay-03s">
                         <div class=" row-table row-flush">
                                ...
                                @if( $autos->image !='' )
                                    <a href="{{ url('/remorque/detaille/'.$autos->id) }}">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail">
                                ...
                                <header>
                                    <div class="pull-left">
                                        <!-- Title -->
                                        <h3 class="title">
                                            <a href="{{ url('/remorque/detaille/'.$autos->id) }}">Audi Q7 2017</a>
                                        </h3>
                                        <!-- Custom List -->
                                ...
                                <!-- Btn Div -->
                                <a href="{{ url('/remorque/detaille/'.$autos->id) }}" class="btn btn-details">Details</a>
                            </div>
