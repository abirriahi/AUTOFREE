    <div class="b-submit__main">
        ...
        {!! Form::open( ['url' => '/camionstep1' , 'method' => 'post','enctype'=>'multipart/form-data','class'=>'s-submit clearfix', 'files'=>true]) !!}
        <div class="row">
...
<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                ...
                <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    ...
                    <div class='s-relative'>
                        {!! Form::select("autos_carrosserie" ,camion_carrosserie() , null ,array('class' => 'm-selecttt', 'placeholder' => 'carrosserie' )) !!}
