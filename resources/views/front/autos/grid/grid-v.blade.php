                                    ...
                                    <div class="carbox-overlap-wrapper" >
                                        ...
                                        <div class="overlap-btns-area">
                                            ...
                                            <div class="featured-ribon">
                                                ...
                                                @elseif($autos->validation ==1 && $autos->enpublic==1  && $autos->user->admin==2 )
                                                    <a href=" {{url('/change_choix/'.$autos->id.'/0')}}">
                                                ...
                                                @elseif($autos->validation ==1 && $autos->enpublic==0  && $autos->user->admin==2)



                                                    <a href=" {{url('/change_choix/'.$autos->id.'/1')}}">
                                                        <h2>Selectionner</h2>
