        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-xs-12">
                    ...
                    <div class="row">
                        @if(count($autos)  )
                            @foreach($autos->chunk(2) as $items )
                                        ...
                                        <div class="thumbnail car-box clearfix wow fadeInUp delay-03s">
                                            ...
                                            <div class="carbox-overlap-wrapper" >
                                                ...
                                                <div class="overlap-btns-area">
                                                    <a href="{{ url('/camping/detaille/'.$autos->id) }}" class="overlap-btn"><i class="fa fa-link"></i></a>
                                                    <div class="featured-ribon">
                                                        @if($autos->validation==0)
                                                            <h2 >En Attente</h2>

                                                        @elseif($autos->validation ==1 && $autos->enpublic==1 )
                                                            <a href=" {{url('/change_choixCC/'.$autos->id.'/0')}}">
                                                        ...
                                                        @elseif($autos->validation ==1 && $autos->enpublic==0 )
                                                            ...
                                                            <a href=" {{url('/change_choixCC/'.$autos->id.'/1')}}">
                                                                <h2>Publier</h2>
