                                ...
                                <div class="section-heading">
                                    <div class="media">
                                        ...
                                        <div class="media-body hidden-xs">
                                            ...
                                            @if($autoInfo->moto_marque!=0)
                                                {{$autoInfo->marque->moto_marque}}
                                            @else
                                                {{$autoInfo->new_marque}}
                                            @endif
                                                <div class="border">
                                                    ...
                                                    @else
                                                        ...
                                                        @if(Auth::user()->id == $autoInfo->user_id)
                                                            ...
                                                            <a href="{{ url('/motoupdate/'.$autoInfo->id) }}" class="title">Modifier</a>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            @if($autoInfo->autos_carrosserie!='')
                                                ...
                                                {{ moto_carrosserie()[$autoInfo->autos_carrosserie] }}
                    ...
                    <div class="details-sidebar pad-div">
                        ...
                        <div class="sidebar-widget car-details-sidebar">
                            @if (Auth::guest())
                                ...
                                <a href="{{url('/motoupdate/'.$autoInfo->id)}}">
