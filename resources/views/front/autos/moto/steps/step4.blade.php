<div class="b-submit__main">
    ...
    {!! Form::open( ['url' => '/motostep4' , 'method' => 'post','enctype'=>'multipart/form-data','class'=>'s-submit clearfix', 'files'=>true]) !!}
        ...
        <div class="col-md-6 col-xs-12">
            ...
            <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                ...
                <div class='s-relative'>
                    ...
                    {!! Form::number("num_tel" , null , array('class' => 'm-selectt','placeholder' => 'numero téléphone ',
                     'style'=>'display: block;
width: 100%;
 padding: 15px 20px;
 font: 400 13px \'Open Sans|\',sans-serif;
