    <div class="b-submit__main">
        ...
        {!! Form::open( ['url' => '/motostep1' , 'method' => 'post','enctype'=>'multipart/form-data','class'=>'s-submit clearfix', 'files'=>true]) !!}
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    ...
                    <div class='s-relative'>
                        ...
                        {!! Form::select("auto_carburan" ,moto_carburan() , null , array('class' => 'm-selectt','placeholder' => 'carburan ' )) !!}
               ...
               <div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
                    ...
                    <div class='s-relative'>
                        {!! Form::select("autos_carrosserie" ,moto_carrosserie() , null ,array('class' => 'm-selecttt', 'placeholder' => 'carrosserie' )) !!}
