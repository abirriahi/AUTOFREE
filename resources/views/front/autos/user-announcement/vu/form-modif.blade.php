                    ...
                    <div class="section-heading">
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                @if($auto->vehicule_marque!= 0  )

                                    {{$auto->vehiculemarque->vehicule_marque}} {{$auto->new_modele}}
        ...
        <div class="form-group search-fields">
            <div class="container">
                ...
                <div class="ligne">
                    ...
                    <div class="colonne">
                        <label>Marque</label>
                        {!! Form::text("new_marque",null,array('class' => 'form-control','placeholder' => 'taper une marque')) !!}
                    ...
                    <div class="colonne">
                        <label>Modèle</label>
                        {!! Form::text("new_modele",null,array('class' => 'form-control','placeholder' => 'taper un modéle')) !!}
                    ...
                    <div class="colonne">
                        <label>Prix</label>
                        <br>
                        {!! Form::number("auto_price", null ,array('class' => 'form-control', 'id' => 'soflow','placeholder' => 'Prix de')) !!}
                ...
                @if(Auth::user()->admin==1)
                    ...
                    <div class="ligne">
                        ...
                        <div class="colonne">
                            ...
                            {!! Form::select("vehicule_marque",App\AutoMarque::where('vehicule_marque','!=','') ->pluck('vehicule_marque','id')
                            ,old('vehicule_marque') ,array('class' => 'form-control m-selectt vehicule_marque_id',
                            'id'=>'','placeholder' => 'taper une marque')) !!}
                            @if ($errors->has('vehicule_marque'))
                                <span class="help-block">
                                                  <strong>{{ $errors->first('vehicule_marque') }}</strong>
                                                     </span>
                            @endif
                        ...
                        <div class="colonne">
                           ...
                           <span class="vehicule_model">
                            ...
                            @if ($errors->has('vehicule_model'))
                                <span class="help-block">
                                                  <strong>{{ $errors->first('vehicule_model_id') }}</strong>
                                                     </span>
                            @endif
                ...
                <div class="ligne">
                    ...
                    <div class="colonne">
                        ...
                        <bR>
                        {!! Form::select("autos_carrosserie" ,VU_carrosserie() , null ,array('class' => 'm-selectt','placeholder' => 'carburan', 'id' => 'soflow' )) !!}
                            ...
                            <div class="panelB">
                                <div class="row vertical-align">
                                    ...
                                    <div >
                                        <label>Canton</label>
                                        <bR>
                                        {!! Form::select("ville" ,ville() , null ,array('id'=>'soflow','placeholder' => 'Canton' )) !!}
                                    ...
                                    <div>
                                        ...
                                        {!! Form::text("num_tel"  , null ,array('id'=>'soflow','placeholder' => 'numero telephone ' )) !!}
                                    ...
                                    <div>
                                        ...
                                        {!! Form::email("email"  , null ,array('id'=>'soflow','placeholder' => 'email ' )) !!}
