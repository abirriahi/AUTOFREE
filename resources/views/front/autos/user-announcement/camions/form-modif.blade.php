                    ...
                    <div class="section-heading">
                        <div class="media">
                            ...
                            <div class="media-body hidden-xs">
                                ...
                                @if($auto->camion_marque!= 0  )

                                    {{$auto->marque->camion_marque}} {{$auto->new_modele}}
    ...
    width: 200px;
                ...
                @if(Auth::user()->admin==1)
                    ...
                    <div class="ligne">
                        ...
                        <div class="colonne">
                            ...
                            {!! Form::select("camion_marque",App\AutoMarque::where('camion_marque','!=','')->pluck('camion_marque','id'),old('camion_marque')
                         ,array('class' => 'form-control m-selectt camion_marque_id','id'=>'','placeholder' => 'taper une marque')) !!}
                            @if ($errors->has('camion_marque'))
                                <span class="help-block">
                                                  <strong>{{ $errors->first('camion_marque') }}</strong>
                                                     </span>
                            @endif
                        ...
                        <div class="colonne">
                            ...
                            @if ($errors->has('camion_model'))
                                <span class="help-block">
                                                  <strong>{{ $errors->first('camion_model_id') }}</strong>
                                                     </span>
                            @endif
                ...
                <div class="ligne">
                    ...
                    <div class="colonne">
                        ...
                        <bR>
                        {!! Form::select("autos_carrosserie" ,camion_carrosserie() , null ,array('class' => 'm-selectt','placeholder' => 'carburan', 'id' => 'soflow' )) !!}
