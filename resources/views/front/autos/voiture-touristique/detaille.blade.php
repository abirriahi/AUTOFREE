                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body hidden-xs">
                                            ...
                                            @if($autoInfo->auto_marque!=0)
                                                {{$autoInfo->marque->auto_marque}} {{$autoInfo->new_modele}}
                                            @else
                                                {{$autoInfo->new_marque}}{{$autoInfo->new_modele}}
                                         @endif
                                ...
                                <div class="header-price">
                                    ...
                                    @else
                                        ...
                                        @if(Auth::user()->id == $autoInfo->user_id)
                                            ...
                                            <a href="{{ url('/update/'.$autoInfo->id) }}" ><i class="fa fa-edit" style="font-size:24px;color:#d20023"></i>
                                            </a>

                                        @elseif(Auth::user()->admin == 1)

                                            <a href="{{ url('/update/'.$autoInfo->id) }}" ><i class="fa fa-edit" style="font-size:24px;color:#d20023"></i></a>
                                    ...
                                    @elseif( count($autoInfo->images) == 2)
                                        <div id="myCarousel" class="carousel slide" data-ride="carousel" >
                                            ...
                                            <div class="carousel-inner" >
                                                ...
                                                @foreach($autoInfo->images as $key => $image)
                                                    <div class="item {{ $key == 0 ? 'active' : '' }} ">
                                                        <img src="{{  Request::root().'/public/front/images/'.$image->path}}"style="height: 523.92px;">
                                                    </div>
                                                @endforeach
                        ...
                        <div class="panel-box">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#tab2default" data-toggle="tab" aria-expanded="false">Equipements</a></li>
                                 <li class=""><a href="#tab3default" data-toggle="tab" aria-expanded="false"> Specifications Technique</a></li>
                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade features" id="tab2default">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-4 col-sm-4 col-xs-6 amenities-box">
                                        ...
                                        <div class="tab-pane fade" id="tab4default">
                                            <div class="inside-car mrg-btm-40 ">
                                                ...
                                                <iframe src={{$autoInfo->video}}></iframe>
                ...
                <div class="col-ld-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="details-sidebar pad-div">
                            ...
                            <ul>
                                ...
                                <li>
                                  ...
                                  <li>
                                    ...
                                    <span>  </span>{{auto_year()[$autoInfo->auto_year]}}
                                ...
                                <li>
                                    ...
                                    @if($autoInfo->auto_siege)
                                        {{ auto_siege()[$autoInfo->auto_siege]}} SIEGES
                                    @else
                                    @endif
                        ...
                        <div class="recent-car recent-cars sidebar-widget">
                            <!-- Title
                            <a href="{{ url('/sameUser/'.$autoInfo->id) }}">
                                <h2 class="title">Autre voitures</h2>
                            </a>-->
                            <h2 class="title">Autre voitures</h2>
                            @if(count($same_user)  )
                                    ...
                                    <a href="#">
                                        @if( $same_user->image !='' )
                                            <a href="{{ url('/detaille/'.$same_user->id) }}">
                                                <img src={{checkIfImageIsexist($same_user->image)}} class="media-object"alt="recent-1">
                                            </a>
                                        @elseif( $same_user->image =='' )
                                            <a href="{{ url('/detaille/'.$same_user->id) }}">


                                                <img src= {{  Request::root().'/slider/'.getSetting('no_image')}} class="media-object"alt="recent-1" >
                                            </a>
                                        @endif
                                        ...
                                        <div class="media-body">
                                            <h3>
                                                <a href="car-details.html">{{$same_user->new_marque}}{{$same_user->new_model}}</a>
                                            </h3>
                                            <span>


                                                October 18, 2016</span>
                                            <p>{{$same_user->auto_price}} CHF</p>
                                        </div>
                            </div>
