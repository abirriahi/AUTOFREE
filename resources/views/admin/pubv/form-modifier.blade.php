...
@section('content')
    ...
    {!! Form::model($pi ,  ['url' => '/adminpanel/pubv/update' , 'method' => 'patch' , 'files' => true]) !!}
    ...
    @if($pi->ok==0)
        ...
        <input   id="carroserie0v" name="ok"    type="checkbox" value="0">
    ...
    @else
        ...
        <input   id="carroserie0xv" name="ok"    type="checkbox" value="0">

        <label for="carroserie0xv">
...
@section('footer')
    <script>
        ...
        $('#carroserie0xv').on('change', function(){
            this.value = this.checked ? 0 : 0;
            // alert(this.value);
        }).change();
    </script>
    <script>
        $('#carroserie0v').on('change', function(){
