...
<head>
  ...
  <title>AutoFree|@yield('title')</title>
...
<div class="wrapper"  style="background-color: white" >
  <header class="main-header">
    <!-- Logo -->
    <a href="{{URL('/adminpanel')}}" class="logo" style="background-color: #d20023" >
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #d20023" >
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Vous avez  nouveau(x) message(s)</li>
              <li>
                ...
                <div class="slimScrollDiv" ><ul class="menu">
                    <li><!-- Task item -->
                       <a href="#">
                          ...
                          <small class="pull-right"><a href="#" >valider </a> </small>
                        </a>
                      </li><!-- end task item -->
  ...
  <aside class="main-sidebar" style="background-color:white">
    ...
    <section class="sidebar" style="background-color: white">
      ...
      <ul class="sidebar-menu" style="background-color: #f6f6f6">
        <li class="header"style="background-color:white ;color: #d20023 "  hidden >Menu principal</li>
  ...
  <footer class="main-footer">
    ...
    <strong> Copyright 2017. All rights reserved by: Auto-store .</strong>
