...
<head>
    ...
    {!! Html::script('front/js/jquery-1.11.3.min.js') !!}
    ...
    <div class="container" >
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <!-- <a href="{{ url('/') }}" >
                    <img src= {{  Request::root().'/front/img/logos/AUTO(5)-email.png'}}>
                </a> -->
...
<!-- Mirrored from auto-dealer-dot-my-experiments-163718.appspot.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Ap